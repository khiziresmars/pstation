    ...
    <div class="container">
        <div class="footer-grid">
            ...
            <div class="footer-col">
                <a href="/" class="footer-logo">
                    <img src="/images/logo-white.svg" alt="<?= $app_name ?>" width="150" height="40">
                </a>
            ...
            <div class="footer-col">
                ...
                <ul class="contact-list">
                    <li>
                        ...
                        <span>Chalong Bay, Phuket, Thailand</span>
                    </li>
                    <li>
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <li>
                        ...
                        <span>info@phuket-yachts.com</span>
                    </li>
                </ul>
            </div>
        ...
        <div class="footer-bottom">
            ...
            <div class="footer-links">
                <a href="<?= $view->url('/privacy') ?>"><?= $t['privacy'] ?></a>
                <a href="<?= $view->url('/terms') ?>"><?= $t['terms'] ?></a>
            </div>
        </div>
    </div>
</footer>
